      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-12">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="font-display text-xl block">Little Seedlings</span>
                <span className="text-cream/60 text-xs tracking-widest uppercase">English Kindergarten</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/60">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+995571903885" className="hover:text-cream transition-colors">+995 571 90 3885</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-cream/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-cream/40 text-sm">
            © {currentYear} Little Seedlings English Kindergarten. {t.footer.rights}
          </p>
